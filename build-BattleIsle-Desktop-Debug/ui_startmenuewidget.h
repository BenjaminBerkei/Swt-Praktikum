...
public:
    ...
    {
        StartMenueWidget->setWindowTitle(QApplication::translate("StartMenueWidget", "Form", 0));
        ...
        groupBox->setTitle(QApplication::translate("StartMenueWidget", "Eingestellte Optionen", 0));
        label_opponent->setText(QApplication::translate("StartMenueWidget", "<strong>Gegner:</strong>", 0));
        label_opponent_indication->setText(QApplication::translate("StartMenueWidget", "Mensch", 0));
        label_limit->setText(QApplication::translate("StartMenueWidget", "<strong>Limit:</strong>", 0));
        label_limit_indication->setText(QApplication::translate("StartMenueWidget", "Keines", 0));
        label_fogOfWar->setText(QApplication::translate("StartMenueWidget", "<strong>Fog of War:</strong>", 0));
        label_fogOfWar_indication->setText(QApplication::translate("StartMenueWidget", "Ein", 0));
        label_map->setText(QApplication::translate("StartMenueWidget", "<strong>Karte:</strong>", 0));
        label_map_indication->setText(QApplication::translate("StartMenueWidget", "Erste", 0));
        label->setText(QApplication::translate("StartMenueWidget", "<html><head/><body><p align=\"center\"><span style=\" font-size:xx-large; font-weight:600;\">Battle Isle Clone</span></p></body></html>", 0));
    } // retranslateUi
