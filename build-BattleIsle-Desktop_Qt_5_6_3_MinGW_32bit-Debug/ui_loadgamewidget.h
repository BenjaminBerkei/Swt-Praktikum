...
public:
    ...
    {
        LoadGameWidget->setWindowTitle(QApplication::translate("LoadGameWidget", "Form", Q_NULLPTR));
        label_LoadGame->setText(QApplication::translate("LoadGameWidget", "<html><head/><body><p align=\"center\"><span style=\" font-size:xx-large; font-weight:600;\">Spiel laden</span></p></body></html>", Q_NULLPTR));
        groupBox_saveGames->setTitle(QApplication::translate("LoadGameWidget", "Gespeicherte Spiele", Q_NULLPTR));
        qbutton_apply->setText(QApplication::translate("LoadGameWidget", "OK", Q_NULLPTR));
        qbutton_cancel->setText(QApplication::translate("LoadGameWidget", "Abbrechen", Q_NULLPTR));
    } // retranslateUi
